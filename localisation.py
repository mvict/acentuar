...
EMPHASIS_EXPLANATION = {
    ...
    "nl": "U had moeten aangeven waar u de klemtoon in dit woord hoort."
   }
...
HELP_BY_ACCENT_TEXT = {
    ...
    "nl": "Hulp moet hier aangeboden worden"
  }
...
SYLLABICATION_ERROR = {
    "en": "Syllabication error occurred while splitsing the word",
